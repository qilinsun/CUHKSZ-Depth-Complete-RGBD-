...
class MP(Dataset):
    ...
    def _load_data_name_matterport(self, 
        ...
        for x in os.listdir(self.data_root):
            ...
            for y in os.listdir(raw_depth_scene):
                ...
                feature_files = [render_depth_f, color_f]
    ...
    def __getitem__(self, index):
        if self.dataset_name == 'matterport':
            ...
            batch = {'scene_name': self.scene_name[index], 'color' : color, 'depth' : depth, 'mask' : mask, 'gt_mask' : gt_mask, 'render_depth' : render_depth}
        return batch
