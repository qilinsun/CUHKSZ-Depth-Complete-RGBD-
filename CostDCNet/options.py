...
class Options:
    def __init__(self):
        ...
        self.parser.add_argument("--gallary_path", type=str, default = './gallary/train_gallary/gallary_silog', help="path of result")
        ...
        self.parser.add_argument('--is_eval', type=bool, default = False, help='evaluation')
