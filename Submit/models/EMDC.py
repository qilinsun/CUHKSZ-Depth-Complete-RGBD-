...
class emdc(nn.Module):
    ...
    def forward(self, rgb, dep):
        ...
        padding = torch.nn.ZeroPad2d((0,0,4,4))
        rgb = padding(rgb)
        dep = padding(dep)
        ...
        # print("fe7 shape: ", fe7.shape)
        # print("fe4 shape: ", fe4.shape)
        # print("fe3 shape: ", fe3.shape)
        # print("fe2 shape: ", fe2.shape)
        # print("fe1 shape: ", fe1.shape)

        fd5 = self.dec5(fe7)
        # print("fd5 shape: ", fd5.shape)
        fd4 = self.dec4(torch.cat((fd5, fe4), dim=1))
        # print("fd4 shape: ", fd4.shape)
        # input()
