    ...
    for i in range(depth.shape[0]):
        for j in range(depth.shape[1]):
            ...
            if (dep != 0):
                ...
                P_rgb_3d = np.dot(R, P_dep_3d) + T # Transform d3 point from depth camera space to rgb cam space.
...
if __name__ == '__main__':
    ...
    depth_folder = "depth"
    aligned_depth_folder =  "new_aligned_depth"
    rgb_folder =  "origin_rgb"
    aligned_depth_rgb_folder = "new_aligned_depth_rgb"
